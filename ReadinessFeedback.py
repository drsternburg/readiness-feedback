...
class ReadinessFeedback(PygameFeedback):
    ...
    def draw_fixation_cross(self):
        self.screen.fill(self.background_color)
        vertical_line = pygame.Surface((2, 25))
        horizontal_line = pygame.Surface((25, 2))
        self.screen.blit(horizontal_line, (self.screen_center[0] - (25/2), self.screen_center[1]))
        self.screen.blit(vertical_line, (self.screen_center[0], self.screen_center[1] - (25/2)))
        pygame.display.update()
        self.last_cross_shown = pygame.time.get_ticks()
